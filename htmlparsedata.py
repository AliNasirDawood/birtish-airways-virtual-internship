...
def extract_data(html_content):
    ...
    return header, author, country, date_published, review_body, type_of_traveller, seat_type, route, date_flown, recommended, tr_rating_elements
...
def html_parse_data(url):
    ...
    if html_content:
        header, author, country, date_published, review_body, type_of_traveller, seat_type, route, date_flown, recommended, tr_rating_elements = extract_data(html_content)
